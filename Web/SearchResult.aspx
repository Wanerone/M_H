<%@ Page Title="" Language="C#" MasterPageFile="~/Nav.Master" AutoEventWireup="true" CodeBehind="SearchResult.aspx.cs" Inherits="Web.SearchResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="biaoqian">
            <div class="biao">  <img  src="Tubiao/结果查询.png" width="70" height="70" /></div>
            <div class="qian">
                查询结果共  <asp:Label ID="Label1" ForeColor="#F6490D" runat="server" ></asp:Label>  条
            </div>
        </div>
    <div class="content">
