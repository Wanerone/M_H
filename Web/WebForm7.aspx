                            ...
                            <asp:Panel ID="Panel1" runat="server" Visible="false">
                                <div class="pinlun">
                                    ...
                                    <div class="lun">
                                        ...
                                        <div><asp:Button ID="Button4" runat="server" Text="发表评论" Height="70" Width="11%"  onclick="button4_Click"/><span style="display: inline;" ><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="评论不能为空"></asp:RequiredFieldValidator></span></div>     
                                    </div>
                                </div>
                            </asp:Panel>
                            <asp:Repeater ID="Repeater2" runat="server">
                                <ItemTemplate>
                                    <div class="con" style="padding-left: 93px; padding-top: 15px;">
